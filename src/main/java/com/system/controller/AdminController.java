...
public class AdminController {
    ...
    public String showStudent(Model model, Integer page) throws Exception {
        ...
        if (page == null || page == 0) {
            ...
            list = studentService.findByPaging(pagingVO);
    ...
    public String addStudent(StudentCustom studentCustom, Model model) throws Exception {
        ...
        userlogin.setPassword(passwordService.encryptPassword("123"));
        userlogin.setRole(2);
    ...
    public String showTeacher(Model model, Integer page) throws Exception {
        ...
        if (page == null || page == 0) {
            pagingVO.setToPageNo(1);
            list = teacherService.findByPaging(pagingVO);
        } else if(page > pagingVO.getTotalPage()) {
            pagingVO.setToPageNo(pagingVO.getTotalPage());
            list = teacherService.findByPaging(pagingVO);
        } else {
    ...
    public String userPasswordRest(Userlogin userlogin) throws Exception {
        ...
        if (u != null) {
            ...
            u.setPassword(passwordService.encryptPassword(userlogin.getPassword()));
