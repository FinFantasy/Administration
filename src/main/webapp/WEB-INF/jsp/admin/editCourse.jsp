        ...
        <div class="co-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/admin/editCourse" id="editform" method="post">
                        <div class="form-group">
                            <label for="courseid" class="col-sm-2 control-label">课程号</label>
                            <div class="col-sm-10">
                                <input readonly="readonly" type="number" class="form-control" id="courseid"
...
<script type="text/javascript">
    ...
    var teacherSelect = $("#teacherid option");
    for (var i=0; i<teacherSelect.length; i++) {
        if (teacherSelect[i].value == '${course.teacherid}') {
