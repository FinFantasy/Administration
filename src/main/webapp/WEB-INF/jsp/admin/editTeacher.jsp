        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/admin/editTeacher" id="editform" method="post">
                        <div class="form-group">
                            <label for="teacherid" class="col-sm-2 control-label">工号</label>
                            <div class="col-sm-10">
                                <input readonly="readonly" type="number" class="form-control" id="teacherid"
                                       name="userid" value="${teacher.userid}" placeholder="请输入工号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="username" name="username"
                                       value="${teacher.username}" placeholder="请输入姓名">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="${teacher.birthyear}" dateStyle="medium" pattern="yyyy-MM-dd"/>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="grade" id="grade" value="<fmt:formatDate
                                value="${teacher.grade}" dateStyle="medium" pattern="yyyy-MM-dd"/>">
                            </div>
                        </div>
                        <div class="form-group">
